...
public class FamilyPackageController {
	...
	public static void executeProcess(String[] args) {
		...
		flightServiceParams.add("Spain : Porto Rico");
		// use fixed value defined from SOA model 

		flightServiceParams.add(args[3]);
		// use value from process input 

		flightServiceParams.add(args[5]);
		// use value from process input 
		...
		hotelServiceParams.add("1");
		// use fixed value defined from SOA model 

		hotelServiceParams.add(args[4]);
		// use value from process input 

		hotelServiceParams.add(args[3]);
		// use value from process input 
		...
		carRentalServiceParams.add("0");
		// use fixed value defined from SOA model 

		carRentalServiceParams.add(args[3]);
		// use value from process input 

		carRentalServiceParams.add(args[0]);
		// use value from process input 

		carRentalServiceParams.add(args[4]);
		// use value from process input 
		...
		insuranceServiceParams.add("123");
		// use fixed value defined from SOA model 
